...
(7, 'AcceptOrder', 'client', '', 'Sayin {firstname} {lastname}, {orderid} numarali siparisiniz onaylanmistir. ', '{firstname},{lastname},{orderid}', 0, ''),
(8, 'AfterModuleCreate_ResellerAccount', 'client', '', 'Sayin {firstname} {lastname}, {domain} icin reseller hizmeti aktif hale getirilmistir. KullaniciAdi: {username} Sifre: {password}', '{firstname}, {lastname}, {domain}, {username}, {password}', 1, ''),
(9, 'InvoicePaymentReminder_FirstOverdue', 'client', '', 'Sayin {firstname} {lastname}, {duedate} son odeme tarihli bir faturaniz bulunmaktadir. Detayli bilgi icin sitemizi ziyaret edin. www.aktuelhost.com', '{firstname}, {lastname}, {duedate}', 1, ''),
...
(12, 'AfterModuleSuspend', 'client', '', 'Sayin {firstname} {lastname}, {domain} alan adli hosting hizmeti duraklatildi.', '{firstname},{lastname},{domain},{username},{password}', 1, ''),
